...
from lstm_w2v_segment import char_freq, sent2veclist, build_lstm_model, load_model, save_model, gen_segmented_sentence
...
def run(label_dict, num_dict, windows, tags, word2idx, test_file, batch_size=128):
    # tags 转化为数字
